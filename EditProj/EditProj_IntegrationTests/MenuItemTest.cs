...
namespace EditProj_IntegrationTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        public void LaunchCommand()
        {
            ...
            {
                CommandID menuItemCmd = new CommandID(rdomunozcom.EditProj.GuidList.guidEditProjCmdSet, (int)rdomunozcom.EditProj.PkgCmdIDList.editProjFile);

                // Create the DialogBoxListener Thread.
                string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "EditProj", "rdomunozcom.EditProj.EditProjPackage");
