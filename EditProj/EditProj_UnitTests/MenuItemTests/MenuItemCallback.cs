...
using rdomunozcom.EditProj;

namespace EditProj_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new EditProjPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(rdomunozcom.EditProj.GuidList.guidEditProjCmdSet, (int)rdomunozcom.EditProj.PkgCmdIDList.editProjFile);
